...
class MyTest(unittest.TestCase):
    def test_get_lower_y_vertex(self):
        points = parse_input("test_input.txt")
        self.assertEqual((1, 7), get_sweep_bounds(points))
    ...
    def test_point_inside_polygon(self):
        ...
        corner1 = (11, 3)
        corner2 = (2, 5)
        rectangle = build_rectangle_from_corners(corner1, corner2)

        corner3 = rectangle[0][1]
        print(corner3)
        corner4 = rectangle[2][1]
        print(corner4)
        # self.assertTrue(point_inside_polygon(polygon, corner1))
        # self.assertTrue(point_inside_polygon(polygon, corner2))
        # self.assertTrue(point_inside_polygon(polygon, corner3))
        self.assertTrue(point_inside_polygon(polygon, corner4))
