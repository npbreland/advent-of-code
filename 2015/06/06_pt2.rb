...
class MyTest < Test::Unit::TestCase
  ...
  def test_lights_lit
    ...
    grid.toggle(0, 0, 2, 2)
    assert_equal(23, grid.lights_lit)
  end
  ...
  def test_process_instruction
    ...
    assert_equal(1, grid.lights_lit)

    grid = Grid.new(1000)
    grid.process_instruction("toggle 0,0 through 999,999")
    assert_equal(2000000, grid.lights_lit)
  end
